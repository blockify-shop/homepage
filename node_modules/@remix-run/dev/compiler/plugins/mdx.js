  ...
  return {
    ...
    async setup(build) {
      ...
      build.onResolve({
        ...
        return {
          path: args.path.startsWith("~/") ? path__namespace.resolve(config.appDirectory, args.path.replace(/^~\//, "")) : path__namespace.resolve(args.resolveDir, args.path),
          namespace: "mdx"
        };
      });
      build.onLoad({
