...
async function getRouteModuleExportsCached(config, routeId) {
  ...
  } catch (error) {// Ignore cache read errors.
  }
  ...
  if (!cached || cached.hash !== hash) {
    ...
    } catch (error) {// Ignore cache put errors.
    }
...
exports.getRouteModuleExportsCached = getRouteModuleExportsCached;
